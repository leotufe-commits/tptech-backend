-- Fase 5 — Comprobantes + cuenta corriente (slice mínimo, sin pagos)
-- Ver diseño completo en src/modules/ARCHITECTURE-RECEIPTS-PAYMENTS.md
...
CREATE UNIQUE INDEX "ReceiptSeries_jewelryId_type_direction_prefix_pointOfSale_key"
    ON "ReceiptSeries" ("jewelryId", "type", "direction", "prefix", "pointOfSale");
...
CREATE INDEX "CurrentAccountMovement_jewelryId_entityId_movementDate_idx"
    ON "CurrentAccountMovement" ("jewelryId", "entityId", "movementDate");
CREATE INDEX "CurrentAccountMovement_receiptId_idx"
    ON "CurrentAccountMovement" ("receiptId");
CREATE INDEX "CurrentAccountMovement_paymentAllocationId_idx"
    ON "CurrentAccountMovement" ("paymentAllocationId");

-- ─────────────────────────────────────────────────────────────────────────────
-- Foreign keys
-- ─────────────────────────────────────────────────────────────────────────────
ALTER TABLE "ReceiptSeries"
    ADD CONSTRAINT "ReceiptSeries_jewelryId_fkey"
    FOREIGN KEY ("jewelryId") REFERENCES "Jewelry" ("id")
    ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "Receipt"
    ADD CONSTRAINT "Receipt_jewelryId_fkey"
    FOREIGN KEY ("jewelryId") REFERENCES "Jewelry" ("id")
    ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "Receipt"
    ADD CONSTRAINT "Receipt_seriesId_fkey"
    FOREIGN KEY ("seriesId") REFERENCES "ReceiptSeries" ("id")
...
ALTER TABLE "Receipt"
    ADD CONSTRAINT "Receipt_purchaseId_fkey"
    FOREIGN KEY ("purchaseId") REFERENCES "Purchase" ("id")
    ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Receipt"
    ADD CONSTRAINT "Receipt_correctedReceiptId_fkey"
    FOREIGN KEY ("correctedReceiptId") REFERENCES "Receipt" ("id")
    ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Receipt"
    ADD CONSTRAINT "Receipt_counterpartyId_fkey"
    FOREIGN KEY ("counterpartyId") REFERENCES "CommercialEntity" ("id")
    ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "Receipt"
    ADD CONSTRAINT "Receipt_issuedById_fkey"
    FOREIGN KEY ("issuedById") REFERENCES "User" ("id")
    ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "Receipt"
    ADD CONSTRAINT "Receipt_voidedById_fkey"
    FOREIGN KEY ("voidedById") REFERENCES "User" ("id")
    ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "ReceiptLine"
    ADD CONSTRAINT "ReceiptLine_receiptId_fkey"
    FOREIGN KEY ("receiptId") REFERENCES "Receipt" ("id")
    ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "ReceiptLine"
    ADD CONSTRAINT "ReceiptLine_articleId_fkey"
    FOREIGN KEY ("articleId") REFERENCES "Article" ("id")
    ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "ReceiptLine"
    ADD CONSTRAINT "ReceiptLine_variantId_fkey"
    FOREIGN KEY ("variantId") REFERENCES "ArticleVariant" ("id")
    ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "ReceiptLine"
    ADD CONSTRAINT "ReceiptLine_jewelryId_fkey"
    FOREIGN KEY ("jewelryId") REFERENCES "Jewelry" ("id")
    ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "CurrentAccountMovement"
    ADD CONSTRAINT "CurrentAccountMovement_jewelryId_fkey"
    FOREIGN KEY ("jewelryId") REFERENCES "Jewelry" ("id")
    ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "CurrentAccountMovement"
    ADD CONSTRAINT "CurrentAccountMovement_entityId_fkey"
    FOREIGN KEY ("entityId") REFERENCES "CommercialEntity" ("id")
    ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "CurrentAccountMovement"
    ADD CONSTRAINT "CurrentAccountMovement_receiptId_fkey"
    FOREIGN KEY ("receiptId") REFERENCES "Receipt" ("id")
    ON DELETE RESTRICT ON UPDATE CASCADE;
